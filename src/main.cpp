      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // Polyfit requires Eigen vectors
          ...
          // Set vehicle position and orientation at origin
          px = 0;
          py = 0;
          psi = 0;

          // Polyfit waypoint values
          ...
          // Use MPC solve to localize vehicle
